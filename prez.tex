...
\begin{frame}{Użyte technologie}
  \begin{itemize}
    ...
    \item SQLite
    \item nginx
    \item API: Duffel, Gepapify (\texttt{httpx async})
  \end{itemize}
\end{frame}
\begin{frame}{Demo}
  \begin{itemize}
...
\begin{frame}{Zbieranie danych o atrakcjach}
  \begin{itemize}
    \item Zbieranie danych o atrakcjach dzieje się asynchronicznie
      podczas działania algorytmu. Dane są zczytywane z bazy
...
\begin{frame}{Walidacja}
  \begin{itemize}
    \item Znalezione drogi są \emph{walidowane}, tzn. sprawdzamy, czy
      sprawdzamy ich dostępność oraz sprawdzamy ceny na aktualne.
