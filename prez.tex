...
\begin{frame}
  \begin{itemize}
    ...
    \item Robi to porozumiewając się z DuffelAPI.
  \end{itemize}
\end{frame}
\begin{frame}
  \begin{itemize}
    \item Dla każdego miasta w bazie mamy do \( 5 \) zdjęć
      popularnych atrakcji z tego miasta.
    \item Atrakcje te są wyświetlane podczas oczekiwania na zwrócenie wyników.
  \end{itemize}
\end{frame}
\end{document}
